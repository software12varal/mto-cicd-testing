...
<head>
    ...
    <title>Coverage for env/lib/python3.8/site-packages/django_countries/models.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>env/lib/python3.8/site-packages/django_countries/models.py</b> :
