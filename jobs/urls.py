...
from users.decorators import varal_admin_required, super_admin_required
...
urlpatterns = [
    ...
    path('', home, name='home'),
    path('admin_monitoring/', super_admin_required(admin_monitoring), name='admin_monitoring'),
